...
const Button: FunctionComponent<ButtonType> = ({ className = "" }) => {
  return (
    <button
      className={`cursor-pointer [border:none] py-boundvariablesdata6 px-boundvariablesdata bg-black-5 w-[42px] !m-[0] absolute top-[16px] right-[16px] rounded-boundvariablesdata4 flex flex-row items-center justify-center box-border z-[1] ${className}`}
    >
